...
Wraith community a harassment-free experience for everyone, regardless of age,
...
- Advocating for, or encouraging, use of this project for fraud, account
  takeover, mass abuse, or any unlawful activity. Wraith is a dual-use tool; the
  community is built around its legitimate uses (see the project's **Responsible
  Use & Legal** section in the [README](README.md)).
...
[GitHub issue](https://github.com/YogevKr/wraith/issues) (for non-sensitive
matters) or through the private channel described in
[SECURITY.md](SECURITY.md) (for sensitive reports). All complaints will be
